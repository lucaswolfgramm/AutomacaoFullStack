...
cf_by='Alexx'
cf_email=''
cf_time='Wed Feb 20 08:25:36 MSK 2019'
charbits='8'
charsize='1'
chgrp=''
chmod='chmod'
...
config_arg20='-Dlibperl=msys-perl5_28.dll'
...
incpath=''
incpth='/usr/lib/gcc/x86_64-pc-msys/7.4.0/include /usr/include'
inews=''
...
mydomain='.nonet'
myhostname='warlock'
myuname='msys_nt-6.1 warlock 2.11.2(0.32953) 2018-11-26 09:22 x86_64 msys '
n='-n'
need_va_copy='undef'
netdb_hlen_type='int'
...
ccflags_nolargefiles='-DPERL_USE_SAFE_PUTENV -U__STRICT_ANSI__ -D_GNU_SOURCE -march=x86-64 -mtune=generic -O2 -pipe -fwrapv -fno-strict-aliasing -fstack-protector-strong'
